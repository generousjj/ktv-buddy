...
const translations: Record<Locale, Record<string, string>> = {
    'en': {
        ...
        'landing.features.spotify.title': 'Spotify Integration',
        'landing.features.spotify.desc': 'Seamlessly connect your Spotify account to sync lyrics directly with your favorite tracks.',
    ...
    'zh-CN': {
        ...
        'landing.features.spotify.title': 'Spotify 集成',
        'landing.features.spotify.desc': '无缝连接您的 Spotify 帐户，直接与您最喜爱的曲目同步歌词。',
    ...
    'zh-TW': {
        ...
        'landing.features.spotify.title': 'Spotify 整合',
        'landing.features.spotify.desc': '無縫連接您的 Spotify 帳戶，直接與您最喜愛的曲目同步歌詞。',
